...
import { DynamicPrimeUploadComponent } from "./dynamic-kendo-upload.component";
...
xdescribe("DynamicKendoUploadComponent test suite", () => {
    ...
    let testModel = new DynamicFileUploadModel({id: "upload", url: ""}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicPrimeUploadComponent>,
        component: DynamicPrimeUploadComponent,
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [DynamicPrimeUploadComponent]

        }).compileComponents().then(() => {

            fixture = TestBed.createComponent(DynamicPrimeUploadComponent);
